...
from apps.Seguridad.app_setting import SEGURIDAD_APPS
from apps.Catalogos.app_setting import CATALOGOS_APPS
...
SECRET_KEY = 'django-insecure-ohaz&u5xhc_3ymyyiqw2chy%z2fvcomxu_nqw5+$#k-o8((wqo'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'VitalisTechBD',  # Nombre de la base de datos
        'HOST': 'DESKTOP-KH3I6EG\SQLEXPRESS',  # IP del servidor SQL Server
        'OPTIONS': {
